                    ...
                    <div class="row s12">
                        <?php if(!empty($documenttypes)){
                            ...
                            foreach ($documenttypes as $documenttype){ ?>                        
                                <?php $metadata_mappings = TDocumenttypeMetadata::model()->findAll("document_type = $documenttype->id AND status = 'A'"); 
                        ...
                        <?php
                            //edit document 
                            include 'modalsDocument/editDocumentType.php';
                            //delete document 
                            include 'modalsDocument/deleteDocumentType.php';
                            //submit document 
                            include 'modalsDocument/submitDocumentType.php';
                        ?>
...
<?php
//add document type
include_once 'modalsDocument/addDocumentType.php';

//EXTERNAL JAVASCRIPT
include_once 'jsCustom/documentType.php';
?>
