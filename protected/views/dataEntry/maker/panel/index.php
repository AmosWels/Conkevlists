        ...
        <div class="col s12 m12 l12">
            <div class="search-page-results">
                <div id="draft">
                    <div class="row s12">
                        <div class="col m4">
                            <a style="font-size: 24px; font: small-caption; font-size: large; font-weight: 400; color: black;" href="<?php echo @Yii::app()->baseUrl; ?>/index.php?r=dataEntry/maker/organisation/index_new"
                        ...
                        <div class="col m4">
                            <a style="font-size: 24px; font: small-caption; font-size: large; font-weight: 400; color: black;" href="<?php echo @Yii::app()->baseUrl; ?>/index.php?r=dataEntry/maker/people/index_new"
                               onmouseover="this.style.color = 'orange';"  onmouseout="this.style.color = 'black';">
                            <div class="card">
                                <div class="card-content z-depth-3" >
...
<!--                        <div class="col m4">
                            ...
                            <div class="card">
                                <div class="card-content" >
                                    <span>Rejected Organisation</span><i class="material-icons right">people_outline</i><br><br>
                                </div>
                            </div>
                            </a>
                        </div>-->
<!--                        <div class="col m4">
                            ...
                            <div class="card">
                                <div class="card-content" >
                                    <span>People Positions</span><i class="material-icons right">person_add</i><br><br>
                                </div>
                            </div>
                            </a>
                        </div>-->
