<div id="discardreason" class="modal">
    <?php
    ...
    <div class="modal-content white">
          <div class="row s12">
              <label class="col s2" for="gender">Reason :</label> <span class="col s10" style="color: black; font-size: 13px"><?php echo $reason_D; ?></span><br>
          </div>
