<div id="takeUp<?php echo $record->id; ?>" class="modal" style="width: 380px;">
    <?php
    ...
    <div class="modal-content" style="height: 140px;background-color: ghostwhite;">
        <h4 style="font-size: 14px; "><?php echo $citeValue->type; ?> Citation</h4>
        <p>Are you sure you want to take up citation with Title : </p>
        <li style="margin-left: 25px"><?php echo $citeValue->title; ?> ? </li>
    </div>
