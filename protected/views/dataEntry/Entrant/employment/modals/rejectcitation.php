...
<div id="cancelcitation" class="modal" >
    ...
    <input type="hidden" name="record_id" value="<?php echo $personcite_attr_id;?>">
    <div class="modal-content" style="background-color: ghostwhite;">
        <h4 style="font-size: 14px; ">Reject Citation with title <span class="green-text"><?php echo $personValue->title; ?></span> ? </h4>
        <div class="row s12">
