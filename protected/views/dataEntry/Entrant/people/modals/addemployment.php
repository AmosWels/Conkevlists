...
<div id="addemployment<?php echo $newp; ?>" class="modal" style="width: 800px;">
    <?php
    ...
    <div class="modal-content white">
        <h4 style="font-size: 14px; ">Add New Employment</h4>
        ...
        <div class="row s12">
            <div class="input-field col s12">
                <input placeholder="....." id="label" name="position_details_new" type="text">
                <label for="label" class="active">Details</label>
            </div>  
        </div> 
        <div class="row s12">
            <div class="input-field col s12">
                <input placeholder="....." id="startdate" type="text" name="position_startdate_new" class="masked" data-inputmask="'mask': 'y/m/d'">
                <label for="startdate" class="active">Start date (y/m/d)</label>
            </div>
        </div> 
        <div class="row s12">
            <div class="input-field col s12">
                <input placeholder="....." id="enddate" type="text" name="position_enddate_new" class="masked" data-inputmask="'mask': 'y/m/d'" >
