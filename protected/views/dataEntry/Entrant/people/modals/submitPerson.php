<!-- submit organization -->
<div id="submit<?php echo $newp; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    <input type="hidden" name="person-id" value="<?php echo $newp;?>">
    <div class="modal-content" style="height: 140px;background-color: ghostwhite;">
        ...
        <li style="margin-left: 25px"><?php echo $newperson->Name; ?></li>
        <?php // } ?>
