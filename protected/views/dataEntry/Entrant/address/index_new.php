...
$address_citation_Taken = TPcitationProfilefieldsMappings::model()->findAll("status IN ('T','C','L') and data_entrant='$userid' and profilefield = '14'"); // getting takenup, corrected and discarded citations

$address_citation_inbox = TPcitationProfilefieldsMappings::model()->findAll("status = 'A' and profilefield = '14'"); // getting new citations

$rejectedaddress = TPersonAddress::model()->findAll("maker = '$userid' and status = 'R'"); // getting rejected address attributes
?>
                        ...
                        <div class="row search-tabs-row search-tabs-container grey lighten-4">
                            <div class="col s12 m3 16">                                
                                <ul class="tabs">
                                    ...
                                    <li class="tab col s4"><a href="#rejected">Rejected<span class="red white-text circle">&nbsp <?php echo count($rejectedaddress); ?> &nbsp;</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>    
...
//                                            nationality name
                                       ...
                                       <code class="red white-text" style="margin-left: 500px;">No Taken up Citations for Address</code>
                                    <?php    }
                                        ?>                                        
                                    </tbody>
                                </table>
