...
$existingpersonaddress = TPersonAddress::model()->findAll("person = $personid and status IN ('A','D','T')");

$usedcitation = TPersonAddress::model()->findAllByAttributes(array('citation'=> $personciteid)); //check if citation has been used to create an attribute
                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 16px">                                    
                                    <div class="breadcrumbs">
                                        ...
                                        <?php echo CHtml::link('Address Citation', array('dataEntry/Entrant/address/index_new')); ?> &sol;
            ...
            <div class="search-page-results">
                ...
                <div class="card z-depth-0">
                    <div class="card-content">
                        <p><span>Search Address with city </span>
                        <span style="margin-left: 540px;"><code class="black-text"><?php echo count($existingpersonaddress);?></code>&nbsp;&nbsp;Existing Address(es)</span></p>
                        <div class="row s12">
                            <?php
...
<?php $this->endWidget(); ?>
                            <div class="col s6" style="overflow: auto; height: 200px; border: dotted; ">
                                <?php 
                                 if(!empty($existingpersonaddress)){
                                     $t = 1;
                                     $color = '';
                                     $addresscolor = '';
...
//                                                getting employment position id
                        ...
                        <div class="row s12">
                            <p>Results <code class="black-text grey lighten-5" style="margin-left: 200px;"><?php echo $resultcount; ?> Possibly matching Address Record(s)</code></p>
