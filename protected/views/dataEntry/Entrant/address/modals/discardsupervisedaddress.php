...
<div id="discard" class="modal">
    ...
    ?>
    <input type="hidden" name="discard-supervision-id" value="<?php echo $addressid; ?>">
    <div class="modal-content" style="background-color: ghostwhite;">
        <h4 style="font-size: 14px; ">Discard Supervision of Address with <code> City </code>
        <span class="grey-text"><span class="black-text"><?php echo $addresscity; ?></span> <code> IN </code> <span class="black-text"><?php echo $addresscountryname; ?></span>
        </span>
        </h4>
        <div class="row s12">
