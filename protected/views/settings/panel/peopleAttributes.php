<?php
$mapped_people_profile = TPcitationProfilefieldsMappings::model()->findAll("status!=''");
$mprofile_id = '';
foreach($mapped_people_profile as $mapped){
    $mprofile_id .= $mapped->profilefield.', ';
}
                            ...
                            <div class="col s12 m12 16">                                
                                <ul class="tabs">
                                    <li class="tab col s12" style="text-align: left">
                                        <span class="grey-text" style="font-size: 14px;">People Attributes</span>&nbsp;&nbsp;<span class="red circle white-text">&nbsp;&nbsp;<?php echo count($model);?>&nbsp;&nbsp;</span> 
                                    </li>  
                                </ul>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                foreach ($model as $record) {
                                    ...
                                    <tr class="" >
                                        ...
                                        <td><a class="<?php echo $color; ?> modal-trigger" href="#peopleAttribute-status<?php echo $record->id;?>"><?php echo $status; ?></a></td>
                                        <td><a href="#editpeople<?php echo $record->id; ?>" class="modal-trigger" style="color: grey;"><i class="material-icons tiny">edit</i></a>
                                ...
                                <?php $r++;
                                    include 'modals/peopleAttributeStatus.php';
                                    include 'modals/deletePeopleAttribute.php';
                                    include 'modals/editPeopleAttribute.php';
                                    } ?>                                        
                            </tbody>
                        </table>
...
<?php
include_once 'modals/createpeopleAttribute.php';
?>