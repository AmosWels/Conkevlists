<div id="peopleAttribute-status<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="peopleattribute-id" value="<?php echo $record->id; ?>">
    <input  type="hidden" name="peopleattribute-status" value="<?php echo $record->status; ?>">
