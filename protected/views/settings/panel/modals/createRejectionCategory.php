<div id="createcategory" class="modal" style="width: 350px;">
    <?php
    ...
    <div class="modal-content white">
        <span class="grey-text text-darken-4">New Category</span> </br>
        <!--<span class="grey-text ultra-small">Field Marked with <span class="red-text">*</span> is required</span>-->
          <div class="row">
            <div class="input-field col s12">
                <input placeholder="....." id="displayname" name="new-category" type="text" required="required">
