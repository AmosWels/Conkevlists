<div id="organizationtype-status<?php echo $record->id; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="organizationtype-id" value="<?php echo $record->id; ?>">
    ...
    <div class="modal-content white" style="height: 115px;">
        <div class="modal-header">
            ...
            <span class="black-text">Organization Type</span>
        </div>
