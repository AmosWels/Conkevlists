<div id="edit-citation-website<?php echo $record->id; ?>" class="modal modal-fixed-footer">
    <?php
    ...
    <div class="modal-content white">
        ...
        <div class="row s12">
            ...
            <div class="col s12 m6">
                <div class="input-field">
                    <input placeholder="....." id="label" name="edit-date-accessed" type="text" required="required" value="<?php echo $record->access_date; ?>" class="masked" data-inputmask="'mask': 'y/m/d'">
