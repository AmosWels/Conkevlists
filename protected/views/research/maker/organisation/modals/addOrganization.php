<!--<div id="add-organization" class="modal modal-fixed-footer" style="width:500px">-->
<div id="add-organization" class="modal modal-footer" style="width:500px">
    <?php
    ...
    <div class="modal-content white">
          <div class="row">
            <div class="input-field col s12">
                <input placeholder="....." id="name" name="new-name-organization" type="text" required="required">
                <label for="name" class="active">Organization Names <span class="red-text">*</span></label>
            </div>  
          </div>
          <div class="row">
            <div class="input-field col s12">
