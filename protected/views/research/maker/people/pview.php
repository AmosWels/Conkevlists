<?php
//get all fields of person table
$personn = TPerson::model()->findAll("Status='D'");
//getting person id
$code = new Encryption;
...
$pcitations = TPersonCitation::model()->findAll("Person=$personid");
//getting profile fields
$Profilefields = TPeopleprofilefields::model()->findAll("Status='A'");
//getting address fields
$Addressfields = TPeopleaddressfields::model()->findAll("Status='A'");
//getting contacts fields
$Contactsfields = TPeoplecontactfields::model()->findAll("Status='A'");
//getting education fields
$Educationfields = TPeopleeducationfields::model()->findAll("Status='A'");
?>
<?php ?>
                            ...
                            <div class="col s12 m12 16">                                
                                <ul class="tabs">
                                    <li class="tab col s10" style="text-align: left">
                                        <span class="grey-text text-darken-4"><?php echo $person->name; ?>
                                            - <small class="grey-text"><?php echo $gendername; ?></small> 
                                            - <small class="grey-text"><i class="material-icons tiny">location_on</i><?php echo $nationalityname; ?></small> 
                                        </span> 
                                    </li>
                                </ul>
                            </div>
...
//                                                                    $profilefields_set = TPcitationProfilefieldsMappings::model()->findAll("citation = $record->id");
//                                                                    $profilemappings = "";
...
//                                                                                $profilefield_name = TPeopleprofilefields::model()->findbypk($item->profilefield);
...
include_once 'modals/addCitationWebsite_person.php';
////submit person
